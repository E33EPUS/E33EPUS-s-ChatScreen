...
**Client** required, **server** optional (needed for quote sync).
...
- **Configurable** (`config/e33chat.json`) — bubble color, text color, background, animations, message
...
- **右键菜单**——复制消息或引用回复
- **点头像 @**——左击他人头像进行@
- **配置项**（`config/e33chat.json`）——气泡颜色、文字颜色、背景、动画、消息预览、强提示等

...
public class ChatMessageStore {
    ...
    public static void addMessage(Component content, UUID senderUUID, Component senderName, boolean isSystem) {
        ...
        if (!screenOpen) {
            unreadCount++;
            boolean systemToHint = isSystem && E33ChatConfig.strongHint;
            boolean mentionToHint = !own && !isSystem && E33ChatConfig.mentionStrongHint
            ...
            if (E33ChatConfig.previewEnabled && !systemToHint && !mentionToHint) {
                ...
                while (previews.size() > E33ChatConfig.previewLines)
                    previews.remove(0);
            }
